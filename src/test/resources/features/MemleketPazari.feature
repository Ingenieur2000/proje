...
#    Given I navigate to the memleket pazari home page
  ...
  Scenario: Positive scenario 1-user should be able to login
    Given I navigate to the memleket pazari home page
    When I click on "Kayıt Ol / Giriş"
    #Then I expect that "Üye Ol" is displayed
    When I enter the "qjhelym330@tmail3.com" "username" input box
    And I enter the "qjhelym330@tmail3.com" "password" input box
    And I click on the "Giriş Yap" button
    #Then I expect that "Hesabım" is displayed
